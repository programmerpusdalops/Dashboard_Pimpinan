...
export default function MapPage() {
    ...
    return (
        <div style={{ position: 'relative', height: 'calc(100vh - 84px)', overflow: 'hidden', margin: '0 -24px -24px -24px', background: 'var(--bg-primary)' }}>
            ...
            <div style={{
                ...
                {/* Sidebar header */}
                <div style={{ padding: '12px 12px 8px', borderBottom: '1px solid var(--map-border)' }}>
